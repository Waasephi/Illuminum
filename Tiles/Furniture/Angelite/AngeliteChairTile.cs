...
public class AngeliteChairTile : ModTile
{
	...
	{
		Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<AngeliteChair>());
	}
	...
	public override void MouseOver(int i, int j)
	{
		...
		player.cursorItemIconID = ModContent.ItemType<AngeliteChair>();
