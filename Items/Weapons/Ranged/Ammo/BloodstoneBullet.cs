...
{
	public class BloodstoneBullet : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.shoot = ModContent.ProjectileType<BloodstoneBulletProjectile>();   //The projectile shoot when your weapon using this ammo
