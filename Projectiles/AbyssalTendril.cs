...
{
    public class AbyssalTendril : ModProjectile
    {
        private bool eyeSpawn = true;

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("AbyssalTendril");
        }
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft == 600) Projectile.ai[0] = 1f;
            ...
            else if (Projectile.ai[0] == 1f)
            {
                ...
                if (distance < 200f) Projectile.Kill();
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("Illuminum/Projectiles/AbyssalTendrilChain", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
