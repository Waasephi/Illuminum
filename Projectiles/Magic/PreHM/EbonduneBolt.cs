...
namespace Illuminum.Projectiles.Magic.PreHM
{
	public class EbonduneBolt : ModProjectile
	{
        ...
        public override void Kill(int timeLeft)
		{
			...
			{
				int num624 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.PurpleTorch, 0f, 0f, 100, default(Color), 1f);
