...
{
	public class BlueJellyBall : ModProjectile
	{
		private int Bounces;
		...
		{
			{
				...
				{
					int num624 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.BubbleBurst_Blue, 0f, 0f, 100, default(Color), 1f);
