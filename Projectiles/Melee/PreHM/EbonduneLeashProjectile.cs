...
{
    public class EbonduneLeashProjectile : ModProjectile
    {
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("Illuminum/Projectiles/Melee/PreHM/EbonduneLeashChain", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
