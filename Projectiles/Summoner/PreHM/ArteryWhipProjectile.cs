...
namespace Illuminum.Projectiles.Summoner.PreHM
{
	public class ArteryWhipProjectile : ModProjectile
	{
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
			...
			Projectile.NewProjectile(Terraria.Entity.InheritSource(Projectile), Projectile.Center, Projectile.velocity * 2, ProjectileID.BloodArrow, Projectile.damage, Projectile.knockBack, Projectile.owner);
		}
