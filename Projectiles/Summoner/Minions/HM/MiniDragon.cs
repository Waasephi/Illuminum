...
namespace Illuminum.Projectiles.Summoner.Minions.HM
{
	...
	public class MiniDragon : ModProjectile
	{
		...
		private bool CheckActive(Player owner)
		{
			...
			{
				owner.ClearBuff(ModContent.BuffType<MiniDragonBuff>());

				return false;
			}

			if (owner.HasBuff(ModContent.BuffType<MiniDragonBuff>()))
			{
