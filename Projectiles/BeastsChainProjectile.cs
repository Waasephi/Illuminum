...
namespace Illuminum.Projectiles
{
	...
	public class BeastsChainProjectile : ModProjectile
	{
		private const string ChainTexturePath = "Illuminum/Projectiles/BeastsChainChain"; // The folder path to the flail chain sprite
		...
		public override void AI()
		{
			...
			float maxRetractSpeed = 15f; // The max speed the projectile will have while retracting
			...
			float maxForcedRetractSpeed = 17f; // The max speed the projectile will have while being forced to retract
			float unusedRetractAcceleration = 1f;
			float unusedMaxRetractSpeed = 14f;
			int unusedChainLength = 60;
			int defaultHitCooldown = 8; // How often your flail hits when resting on the ground, or retracting
			int spinHitCooldown = 15; // How often your flail hits when spinning
			int movingHitCooldown = 9; // How often your flail hits when moving
